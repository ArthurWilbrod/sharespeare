...
Rails.application.config.assets.precompile += %w( book_back1.jpeg )
Rails.application.config.assets.precompile += %w( back_img2.jpeg )
Rails.application.config.assets.precompile += %w( back_img3.jpeg )
Rails.application.config.assets.precompile += %w( back_img4.jpeg )
Rails.application.config.assets.precompile += %w( back_img5.jpeg )
Rails.application.config.assets.precompile += %w( back_img6.jpeg )
Rails.application.config.assets.precompile += %w( back_img7.jpeg )
Rails.application.config.assets.precompile += %w( back_img8.jpeg )
Rails.application.config.assets.precompile += %w( back_img9.jpeg )
